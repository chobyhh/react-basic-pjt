...
export default function Detail(){
    ...
    return(
        <div style={{maxWidth: "350px", width: "80vw", height: "30vh", margin: "5vh auto", padding: "1vh 1vw", border: "1px solid rgb(221, 221, 221)", boxSizing: "border-box", borderRadius: "5px"}}>
            <h4>
